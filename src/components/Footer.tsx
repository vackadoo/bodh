...
const Footer = () => {
  ...
  return (
    <div className="w-full flex flex-col bg-[#FBE9CF]">
      {/* --- Top Decorative Border Image --- */}
      {/* -mb-1 ensures the image sits flush with the footer color without a gap */}
      <div className="w-full h-6 sm:h-7 md:h-8 z-10 -mb-1 overflow-hidden">
        <img
          src="/border.png"
      ...
      <footer className="w-full pt-10 pb-6 px-6 relative">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-5 flex flex-col items-start gap-6">
              ...
              <div className="flex items-center gap-4 group">
                <div className="w-14 h-14 rounded-xl bg-[#FBE9CF] flex items-center justify-center shadow-lg shadow-[#4B2418]/10">
                  <img
                    src="/logo.png"
                ...
                <div>
                  <h2 className="text-xl font-black text-[#3B1D14] tracking-wider leading-none">
                    BHARAT BODH
                  </h2>
                  <p className="text-sm font-bold text-[#5A3A2E] tracking-[0.15em] mt-1">
                    SAMVAD SERIES
                  </p>
                </div>
              </div>

              <p className="text-[#5A3A2E]/90 text-sm leading-relaxed max-w-sm font-medium">
                Unfolding the civilizational ethos of India through dialogue,
                reflection, and future-forward thinking.
              </p>
              ...
              <div className="flex gap-3 mt-2">
                {socialLinks.map((social) => (
                  <a
                    key={social.name}
                    href={social.href}
                    className="w-9 h-9 flex items-center justify-center rounded-full border border-[#D9C0A3] text-[#5A3A2E] hover:bg-[#4B2418] hover:text-[#FBE9CF] hover:border-[#4B2418] transition-all duration-300"
                  >
                    {social.icon}
                  </a>
                ))}
            ...
            <div className="lg:col-span-3 lg:col-start-7 pt-2">
              <h3 className="text-[#3B1D14] font-bold text-lg mb-5 flex items-center gap-2">
                <span className="w-8 h-[2px] bg-[#3B1D14]"></span>
                Series
              </h3>
              <ul className="space-y-3">
                {seriesLinks.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="group flex items-center text-[#5A3A2E] hover:text-[#9C4221] font-medium text-sm transition-colors"
                    >
                      <svg
                        className="w-0 h-4 mr-0 text-[#9C4221] -translate-x-2 opacity-0 group-hover:w-4 group-hover:mr-1 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth={2}
            ...
            <div className="lg:col-span-3 pt-2">
              ...
              <div className="space-y-5 text-sm text-[#5A3A2E]">
                <div className="flex gap-3 items-start">
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-5 h-5 text-[#9C4221] mt-0.5 shrink-0"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <div>
                    <span className="block font-bold text-[#3B1D14]">
                      New Delhi, India
                    </span>
                    <span className="opacity-80">Registered Office</span>
                  </div>
                </div>
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <a
                    href="mailto:contact@bharatbodh.org"
                    className="font-bold text-[#3B1D14] hover:text-[#9C4221] transition-colors hover:underline decoration-[#9C4221]/30"
                  >
                    contact@bharatbodh.org
                  </a>
                </div>
              </div>
            </div>
          ...
          {/* --- Footer Bottom --- */}
          <div className="pt-6 border-t border-[#4B2418]/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-semibold text-[#7A4C35]">
            <p>2026 Bharat Bodh Samvad Series</p>
            <div className="flex gap-6">
              <a href="#" className="hover:text-[#3B1D14] transition-colors">
                Privacy Policy
              </a>
